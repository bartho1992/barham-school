...
def notes():
    ...
    return render_template('notes/index.html', classes=Classe.query.filter_by(ecole_id=ecole_id).all(), ecole=Ecole.query.get(ecole_id))
...
def notes_saisir(classe_id, trimestre):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('notes_saisir', classe_id=classe_id, trimestre=trimestre, matiere_id=m_id))
    ...
    return render_template('notes/saisir.html', classe=cl, eleves=els, matieres=mats, trimestre=trimestre, notes_dict=nd, ecole=e, selected_matiere_id=selected_matiere_id)

@app.route('/bulletins')
@login_required
def bulletins():
    ecole_id = get_current_ecole_id()
    return render_template('notes/bulletins.html', classes=Classe.query.filter_by(ecole_id=ecole_id).all(), ecole=Ecole.query.get(ecole_id))
...
def bulletin_classe(classe_id, trimestre):
    ...
    return render_template('notes/bulletin_detail.html', classe=cl, bulletins=data, trimestre=trimestre, ecole=e)
